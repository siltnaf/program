...
extern volatile uint16 Time_us,Time_ms,Time_sec,Time_min,Time_cnt,scan_sec;
extern volatile bit Timer_update,Beep, UV_on,ion_on,switch_update,scan,unlock;
